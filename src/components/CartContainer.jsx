      ...
      {cartItems && cartItems.length > 0 ? (
        <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
            {/* cart Item */}
            {cartItems && cartItems.length > 0 && cartItems.map((item) => <CartItems key={item.id} item={item} setFlag={setFlag} flag={flag} />)}
          </div>
          ...
          <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
            ...
            <div className="w-full flex items-center justify-between">
              ...
              <p className="text-gray-400 text-lg">Rp 5000</p>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
              ...
              <p className="text-gray-200 text-xl font-semibold">Rp {tot + 5000}</p>
            </div>
